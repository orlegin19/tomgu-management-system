         ...
         <div class="card mb-4 text-white bg-dark">
            ...
            <div class="card-body">
               ...
               <div class="pull-right">
              	...
              	<a href="javascript:void(0)" class="btn btn-outline-light btn-sm remove_prod" onclick="delete_pg()">Delete</a>
               </div>
            </div>
         </div>
    </div>
...
<script>
    function delete_pg($id = 'all'){
        start_loader();
        $.ajax({
            url:'<?php echo base_url().'products/product_type/delete_pg/' ?>',
            method:'POST',
            data:{id:$id},
            error:(err)=>{
                console.log(err)
